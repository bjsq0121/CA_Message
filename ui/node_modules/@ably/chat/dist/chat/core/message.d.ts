import { SummaryDistinctValues, SummaryMultipleValues, SummaryUniqueValues } from 'ably';
import { ChatMessageActions, MessageEvent, MessageReactionSummaryEvent } from './events.js';
...
export declare class DefaultMessage implements Message {
    ...
    readonly reactions: MessageReactions;
    readonly operation?: Operation;
    constructor({ serial, clientId, roomId, text, metadata, headers, action, version, createdAt, timestamp, reactions, operation, }: DefaultMessageParams);
    get isUpdated(): boolean;
    get isDeleted(): boolean;
    get updatedBy(): string | undefined;
    get deletedBy(): string | undefined;
...
export declare function emptyMessageReactions(): MessageReactions;
