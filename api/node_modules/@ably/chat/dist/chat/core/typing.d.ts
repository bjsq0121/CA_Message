import { TypingSetEvent, TypingSetEventTypes } from './events.js';
...
export declare class DefaultTyping extends EventEmitter<TypingEventsMap> implements Typing {
     ...
     */
    constructor(roomId: string, options: InternalTypingOptions, channel: Ably.RealtimeChannel, clientId: string, logger: Logger);
    /**
