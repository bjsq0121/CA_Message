...
export interface MessagesReactions {
    ...
    add(message: {
        serial: string;
    }, params: AddMessageReactionParams): Promise<void>;
    /**
    ...
    delete(message: {
        serial: string;
    }, params?: DeleteMessageReactionParams): Promise<void>;
    /**
...
export declare class DefaultMessageReactions implements MessagesReactions {
    ...
    constructor(_logger: Logger, _options: MessageOptions | undefined, _api: ChatApi, _roomID: string, _channel: Ably.RealtimeChannel);
